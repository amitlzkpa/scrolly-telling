...
export function availableTweenLabels() {
  let ls = Object.keys(this);
  ls.splice(ls.indexOf("availableTweenLabels"), 1);
  ls.splice(ls.indexOf("labelToFn"), 1);
  return ls;
}

export function labelToFn(labelName) {
